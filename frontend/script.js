 ...
 * (e.g., "https://LUCY.example.com"). During local development, it falls
...
/* ================================================================
   ...
   consists of:
     - An avatar circle ("J" for LUCY, "U" for user)
 ...
 *     <div class="msg-body">
 *       <div class="msg-label">LUCY (General) | You</div>
...
function addMessage(role, text) {
    ...
    label.textContent = role === 'assistant'
        ? `LUCY  (${currentMode === 'realtime' ? 'Realtime' : 'General'})`
        : 'You';
...
function addTypingIndicator() {
    ...
    const label = document.createElement('div');
    label.className = 'msg-label';
    label.textContent = `LUCY  (${currentMode === 'realtime' ? 'Realtime' : 'General'})`;
